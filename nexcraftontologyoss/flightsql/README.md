...
11. [`docs/10-driver-worker.md`](docs/10-driver-worker.md) — driver/worker architecture, multi-tenancy, Redis coordination
12. [`docs/11-caching.md`](docs/11-caching.md) — result cache, plan cache, availability via stale modes
13. [`docs/12-bi-integration.md`](docs/12-bi-integration.md) — Flight SQL introspection, Tableau and Power BI
14. [`docs/13-long-running-queries.md`](docs/13-long-running-queries.md) — async submission for multi-minute queries
15. [`jobs/00-overview.md`](jobs/00-overview.md) — `nexcraft-jobs` overview
16. [`jobs/01-recipes.md`](jobs/01-recipes.md) — the recipe pattern
17. [`jobs/02-temporal.md`](jobs/02-temporal.md) — Temporal runtime design
18. [`jobs/03-duckdb-udfs.md`](jobs/03-duckdb-udfs.md) — DuckDB compute layer and analytical UDFs
19. [`jobs/04-storage.md`](jobs/04-storage.md) — result persistence
